...
Elastic Net
"""
# Модель линейной регрессии, обученная с использованием L1 и L2 до использования регуляризатора.
# Используется, когда есть несколько функций, которые коррелируют друг с другом.
