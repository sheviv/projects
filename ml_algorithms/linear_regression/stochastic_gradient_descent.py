...
"""
# Измеряет локальный градиент функции ошибок относительно вектора параметров, идет в направлении нисходящего градиента.
# Когда градиент равен нулю - достигли минимума.
